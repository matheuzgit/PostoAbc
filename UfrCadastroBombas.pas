...
begin
  ...
  begin
    if EdtIdBomba.Text = QryBombasBOMBA.AsString then
    begin
      ...
      begin
        ...
        QryTanque.SQL.Add('where BOMBA = '''+EdtIdBomba.Text+'''');
        QryTanque.ExecSQL;
  ...
  QryBombas.Params.ParamByName('BOMBA').AsString := EdtIdBomba.Text;
